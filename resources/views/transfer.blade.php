      ...
      <div class="col-10">
        ...
        <form class="" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control col-5" id="receiver_account_number" name="receiver_account_number" placeholder="Enter receiver account number" required>
          </div>
          <div class="form-group">
            <label for="amount">Amount</label>
            <input type="text" class="form-control col-5" id="amount" name="amount" placeholder="Enter amount to transfer" required>
          </div>
